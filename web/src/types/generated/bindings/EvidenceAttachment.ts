 ...
 */
source_definition_revision_id: string | null, milestone_id: string | null, acceptance_check_ids: Array<string>, caption: string, kind: EvidenceKind, checksum: string, availability: EvidenceAvailability, author: PrincipalRef, captured_at: string, version: bigint, created_at: string, removed_at: string | null, };
